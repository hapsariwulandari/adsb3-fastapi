...
def read_root():
    ...
    return {"Welcome to Studio Ghibli API":"","To see average score by each director":"https://hapsari-studio-ghibli.herokuapp.com/average_score_director",
            "To see average score by each producer":"https://hapsari-studio-ghibli.herokuapp.com/average_score_producer",
            "To show how many films released by each director":"https://hapsari-studio-ghibli.herokuapp.com/productive_director",
            "To show how many films released by each producer":"https://hapsari-studio-ghibli.herokuapp.com/productive_producer",
            "To show top five films from list":"https://hapsari-studio-ghibli.herokuapp.com/top_five",
            "To show top 10 film sorted by the longest duration":"https://hapsari-studio-ghibli.herokuapp.com/longest_film_duration",
            "To show film ranked by its score from highest to lowest":"https://hapsari-studio-ghibli.herokuapp.com/film_rank_score"}
